...
class main:
    def __init__(self):
        ...
        self.Courses = {"Electromagnétisme" : "https://auth.sorbonne-universite.fr/cas/login?service=https%3A%2F%2Fmoodle-sciences-22.sorbonne-universite.fr%2Flogin%2Findex.php%3FauthCAS%3DCAS",
    ...
    def CheckCourses(self):
        ...
        for course in self.Courses:
            self.browser.get(self.Courses[course])
            self.Login()
            sleep(0.3)
